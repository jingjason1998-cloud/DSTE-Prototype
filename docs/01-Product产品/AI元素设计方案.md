...
> **⚠️ 评审提示（2026-08-21，基准 v0.7.31）**：本方案为草稿且长期未评审。知识中心实际发布形态为**静态知识库**（`src/knowledge.html`，十五五规划知识库，v0.7.27/28），与本文第六章「知识中心 AI 辅助」设计的聚合型知识中心（KnowledgeAsset 同步引擎）方向已偏离；P0 能力（AI 洞察提取、洞察→专题 AI 推荐、年度深化 AI 建议）亦无对应实现。本方案需**重新评审**后方可作为开发依据。
...
- 《战略洞察-完整设计方案.md》：AI 洞察提取；
- 《战略专题管理-完整设计方案.md》：AI 专题推荐、专题报告质量分析、年度深化 AI 建议、甘特图 AI 标注；
- 《知识中心-完整设计方案.md》：AI 摘要、AI 问答（⚠️ 未采纳，2026-08-21 已归档至 `docs/.archive/`；现行见 `docs/02-RFC功能设计/014-knowledge-hub.md`）。
